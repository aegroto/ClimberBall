 ...
 * @author lorenzo
 */
public class GrassChunk extends TerrainChunk {
    
    public GrassChunk(Vector3f startPoint, Node rootNode, Skin environmentSkin,Material mat) {
        super(startPoint, rootNode, environmentSkin, mat);       
        this.surfaceType=3;
        
        surfaceGeom.setMaterial(this.skin.getGrassSkin().getMaterial());
